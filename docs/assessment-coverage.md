...
-p no:cacheprovider --basetemp=/var/tmp/lighthouse-pr-delivery-8sn7bl/full-tests-final2`
— **1,450 passed in 37.71 seconds**. The temporary test directory is disposable.
