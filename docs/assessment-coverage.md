...
-p no:cacheprovider --basetemp=/var/tmp/lighthouse-pr-delivery-8sn7bl/full-tests-after-bot-fixes`
— **1,446 passed in 38.41 seconds**. The temporary test directory is disposable.
