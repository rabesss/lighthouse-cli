...
-p no:cacheprovider --basetemp=/var/tmp/lighthouse-pr-delivery-8sn7bl/full-tests-final4`
— **1,456 passed in 36.82 seconds**. The temporary test directory is disposable.
