...
-p no:cacheprovider --basetemp=/var/tmp/lighthouse-pr-delivery-8sn7bl/full-tests-final`
— **1,447 passed in 39.21 seconds**. The temporary test directory is disposable.
