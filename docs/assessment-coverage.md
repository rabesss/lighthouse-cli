...
-p no:cacheprovider --basetemp=/var/tmp/lighthouse-pr-delivery-8sn7bl/full-tests-final3`
— **1,453 passed in 36.47 seconds**. The temporary test directory is disposable.
